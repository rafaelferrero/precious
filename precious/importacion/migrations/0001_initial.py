# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-12-16 15:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ImportarPreciosInicialesCodigos',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('archivo', models.FileField(upload_to='')),
                ('fila_titulo', models.BooleanField(default=True, verbose_name='La primer fila contiene los títulos de las columnas')),
                ...
                ('columna_nombre', models.IntegerField(default=2, verbose_name="Columna de 'Nombres de las Prácticas'")),
                ('columna_observaciones', models.IntegerField(blank=True, null=True, verbose_name="Columna de las 'Observaciones de las Prácticas'")),
                ('columna_precio', models.IntegerField(verbose_name='Columna de Precios del Código de Práctica')),
                ('convenio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='convenio.Convenio')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ImportarPrecios_creador', to=settings.AUTH_USER_MODEL)),
                ('updater', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ImportarPrecios_modificador', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Importar Precio Inicial en formato Excel (.xls)',
                'verbose_name_plural': 'Importar Precios Iniciales en formato Excel (.xls)',
            },
        ),
    ]

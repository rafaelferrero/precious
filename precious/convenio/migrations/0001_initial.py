    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_archivo', models.CharField(choices=[('C', 'Códigos de Nomenclador del Prestador'), ('H', 'Homologación de Códigos de Nomenclador')], default='C', max_length=15, verbose_name='Tipo de Archivo')),
                ('fila_titulo', models.BooleanField(default=True, verbose_name='La primer fila contiene los títulos de las columnas')),
                ('columna_codigo', models.IntegerField(default=0, verbose_name='Columna de Códigos de Nomenclador del Prestador')),
                ('columna_nombre', models.IntegerField(default=1, verbose_name='Columna de nombres de los Códigos de Nomenclador')),
                ('columna_tipo', models.IntegerField(blank=True, null=True, verbose_name='Columna de Tipo de Práctica del Prestador')),
                ('columna_detalle', models.IntegerField(blank=True, null=True, verbose_name='Columna de Detalles de los Códigos de Nomenclador')),
                ('columna_codigo_homologado', models.IntegerField(blank=True, null=True, verbose_name='Columna de Código Homologado')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creador', to=settings.AUTH_USER_MODEL)),
                ('prestador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='convenio.Prestador')),
                ('updater', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modificador', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Subir archivo en formato Excel (.xls)',
                'verbose_name_plural': 'Subir archivos en formato Excel (.xls)',
            },
        ),
        migrations.CreateModel(
            name='TipoPractica',
